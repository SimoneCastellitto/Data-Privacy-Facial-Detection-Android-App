    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_import:
                ...
                return true;
            case R.id.menu_all_faces:
                mPresenter.start();
                return true;
            case R.id.menu_faces0:
                mPresenter.showSomeImages(0);
                return true;
            case R.id.menu_faces1:
                mPresenter.showSomeImages(1);
                return true;
            case R.id.menu_faces2:
                mPresenter.showSomeImages(2);
                return  true;
            case R.id.menu_faces3:
                mPresenter.showSomeImages(3);
                return  true;
            default:
